...
```txt
feat: preparar pacote visual Aeon Primevo
```

## Description

```txt
Consolida o repertório Aeon-Primevo no Mão na Massa Final da Jus 9, com padrão visual obrigatório, modelo de assinatura com ©, orientações de leitura obrigatória, segurança, classificação de conteúdo e instruções para futuras alterações.
